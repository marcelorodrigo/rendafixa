...
CalculadoraApp.controller('RentabilidadeController', function ($scope, $http) {
    ...
    $scope.calculate = function () {
        ...
        $scope.result.valorBruto = math.format(valorFinal, {notation: 'fixed', precision: 2});
        $scope.result.pre = math.format(taxaAnualFull, {notation: 'fixed', precision: 2});
        $scope.result.pos = math.format(taxaPosFull, {notation: 'fixed', precision: 2});
