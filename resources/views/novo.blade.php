...
<div class="alert alert-warning" role="alert">
    ...
    <div><br />Sabemos que é incomodo ter um novo endereço, então anote aí <a href="https://rendafixa.github.io/" title="Calculadora Renda Fixa" class="alert-link">https://rendafixa.github.io</a><br />
        Nosso projeto <a href="https://rendafixa.github.io/" title="Calculadora Renda Fixa" class="alert-link">Calculadora Renda Fixa</a>
        está sendo hospedado pelo GitHub que oferece o que precisamos
        para manter o nosso projeto no ar :)</div>
    <p><br />O site atual será desativado automaticamente pela Heroku em 28 de novembro!</p>
    <hr>
    <button type="button" class="btn btn-outline-success">https://rendafixa.github.io/</button>
</div>
@endsection
